      ...
      <View>
        <View style={[styles.con, { zIndex: 10000 }]}>
          <TextInput
            ...
            style={[
              styles.textInput,
              this.props.arrowdown && this.props.disabled && { opacity: 0.4 },
            ]}
            theme={{
              colors: {
                primary: "#979797",
              ...
              this.props.showSelected
                ? this.state.selected_currency
                  ? this.props.type == "country"
                    ? this.state.selected_currency.country_name
                    : "             " +
          ...
          {this.props.showflag && this.state.selected_currency && (
            <Avatar
              rounded
              size={20}
              avatarStyle={{}}
              source={{ uri: this.state.selected_currency.country_flag }}
              containerStyle={{
                position: "absolute",
                width: 35,
                height: 35,
        ...
        <Animated.View
          style={[
            ...
            this.props.arrowdown && this.props.disabled && { opacity: 0 },
          ]}
        >
          <ScrollView
            horizontal
